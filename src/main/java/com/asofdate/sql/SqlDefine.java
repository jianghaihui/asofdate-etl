...
public class SqlDefine {
    ...
    public static String sys_rdbms_010 = "select f.authorization_level from sys_user_info t inner join sys_org_info i on t.org_unit_id = i.org_unit_id inner join sys_domain_share_info f on f.domain_id = ? and i.domain_id = f.target_domain_id where t.user_id = ?";
    ...
    public static String sys_rdbms_041 = "select org_unit_id,org_unit_desc,up_org_id,t.domain_id,create_date,maintance_date,create_user,maintance_user,code_number from sys_org_info t where t.domain_id = ?";
    ...
    public static String sys_rdbms_047 = "select t.role_id,t.role_name,t.code_number from sys_role_info t where ( t.role_owner = ? or exists ( select 1 from sys_role_user_relation r where r.user_id = ? and t.role_id = r.role_id )) and not exists (select 1 from sys_role_user_relation n where n.user_id = ? and t.role_id = n.role_id )";
    ...
    public static String sys_rdbms_084 = "select t.domain_id as project_id, t.domain_name as project_name, s.domain_status_name  as status_name, t.domain_create_date  as maintance_date, t.domain_owner as user_id,t.domain_maintance_date,t.domain_maintance_user from sys_domain_info t inner join sys_domain_status_attr s  on t.domain_status_id = s.domain_status_id where t.domain_id = ?";
    public static String sys_rdbms_085 = "select t.domain_id as project_id, t.domain_name as project_name from sys_domain_info t where not exists ( select 1 from sys_domain_share_info i where t.domain_id = i.target_domain_id and i.domain_id = ? )";
    ...
    public static String sys_rdbms_087 = "delete from sys_domain_share_info where uuid = ? and domain_id = ?";
    ...
    public static String sys_rdbms_096 = "insert into sys_role_user_relation(uuid,role_id,user_id,maintance_date,maintance_user) values(uuid(),?,?,now(),?)";
    public static String sys_rdbms_097 = "delete from sys_role_user_relation where user_id = ? and role_id = ?";
    ...
    public static String sys_rdbms_167 = "insert into dispatch_batch_job_status(batch_id,job_id,status) values(?,?,?)";
    ...
    public static String sys_rdbms_192 = "insert into dispatch_batch_history(uuid,batch_id,batch_status,as_of_date,start_time,end_time,ret_msg,domain_id) select uuid(),batch_id,batch_status,as_of_date,start_date,end_date,ret_msg,domain_id from dispatch_batch_define where batch_id = ?";
    public static String sys_rdbms_193 = "select t.uuid,d.code_number,t.batch_id,d.batch_desc,t.batch_status,a.batch_status_desc,t.as_of_date,t.start_time,t.end_time,t.ret_msg,t.domain_id from dispatch_batch_history t inner join dispatch_batch_define d on t.batch_id = d.batch_id inner join dispatch_batch_status_attr a on t.batch_status = a.batch_status where t.domain_id = ?";
