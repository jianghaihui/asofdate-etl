...
public class SqlDefine {
    ...
    public static String sys_rdbms_135 = "select t.id,t.arg_id,t.arg_value,t.domain_id,r.group_id,r.task_id from dispatch_group_argument_relation t inner join dispatch_group_task_relation r on t.id = r.id where t.id = ?";
    ...
    public static String sys_rdbms_146 = "update dispatch_group_argument_relation set arg_value = ? where id = ? and arg_id = ?";
    ...
    public static String sys_rdbms_149 = "insert into dispatch_group_argument_relation(uuid,id,arg_id,arg_value,domain_id) values(uuid(),?,?,?,?)";
