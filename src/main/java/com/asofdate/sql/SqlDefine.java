...
public class SqlDefine {
    ...
    public static String sys_rdbms_192 = "insert into dispatch_batch_history(uuid,batch_id,batch_status,as_of_date,start_time,end_time,ret_msg,domain_id) select ?,batch_id,batch_status,as_of_date,start_date,end_date,ret_msg,domain_id from dispatch_batch_define where batch_id = ?";
